...
**Database design:** a `dim_date` dimension table joined to per-source fact tables (`fact_cbn_inflation`, `fact_nbs_cpi`, with more indicators being added), enabling clean time-series joins across every economic indicator in the project.
...
- [ ] Exchange rate & foreign reserves data
